...
public class AnimatableTransformParser {
    ...
    public static AnimatableTransform parse(
        ...
        AnimatableTransform transform = new AnimatableTransform(anchorPoint, position, scale, rotation, opacity, startOpacity, endOpacity, skew, skewAngle);
        transform.setPty(pty);
        return transform;
    }
